...
import io.gravitee.llama.cpp.linux.x86_64.constants$139;
import io.gravitee.llama.cpp.linux.x86_64.constants$140;
...
public class llama_batch {
    ...
    public static MemorySegment token$get(MemorySegment seg) {
        return (MemorySegment)constants$140.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment token$get(MemorySegment seg, long index) {
        return (MemorySegment)constants$140.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment embd$get(MemorySegment seg) {
        return (MemorySegment)constants$140.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment embd$get(MemorySegment seg, long index) {
        return (MemorySegment)constants$140.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment pos$get(MemorySegment seg) {
        return (MemorySegment)constants$140.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pos$get(MemorySegment seg, long index) {
        return (MemorySegment)constants$140.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment n_seq_id$get(MemorySegment seg) {
        return (MemorySegment)constants$140.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment n_seq_id$get(MemorySegment seg, long index) {
        return (MemorySegment)constants$140.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment seq_id$get(MemorySegment seg) {
        return (MemorySegment)constants$140.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment seq_id$get(MemorySegment seg, long index) {
        return (MemorySegment)constants$140.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment logits$get(MemorySegment seg) {
        return (MemorySegment)constants$140.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment logits$get(MemorySegment seg, long index) {
        return (MemorySegment)constants$140.const$5.get(seg.asSlice(index*sizeof()));
    }
