...
final class constants$142 {
    ...
    static final VarHandle const$0 = constants$140.const$0.varHandle(MemoryLayout.PathElement.groupElement("use_mlock"));
    static final VarHandle const$1 = constants$140.const$0.varHandle(MemoryLayout.PathElement.groupElement("check_tensors"));
    ...
    static final VarHandle const$3 = constants$142.const$2.varHandle(MemoryLayout.PathElement.groupElement("n_ctx"));
    static final VarHandle const$4 = constants$142.const$2.varHandle(MemoryLayout.PathElement.groupElement("n_batch"));
    static final VarHandle const$5 = constants$142.const$2.varHandle(MemoryLayout.PathElement.groupElement("n_ubatch"));
}
