...
public class _IO_cookie_io_functions_t {
    ...
    public static MemorySegment read$get(MemorySegment seg) {
        return (MemorySegment)constants$8.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment read$get(MemorySegment seg, long index) {
        return (MemorySegment)constants$8.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment write$get(MemorySegment seg) {
        return (MemorySegment)constants$8.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment write$get(MemorySegment seg, long index) {
        return (MemorySegment)constants$8.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment close$get(MemorySegment seg) {
        return (MemorySegment)constants$8.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment close$get(MemorySegment seg, long index) {
        return (MemorySegment)constants$8.const$5.get(seg.asSlice(index*sizeof()));
    }
