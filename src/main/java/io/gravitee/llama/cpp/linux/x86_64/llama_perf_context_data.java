...
public class llama_perf_context_data {
    ...
    public static double t_start_ms$get(MemorySegment seg) {
        return (double)constants$195.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static double t_start_ms$get(MemorySegment seg, long index) {
        return (double)constants$195.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static double t_load_ms$get(MemorySegment seg) {
        return (double)constants$195.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static double t_load_ms$get(MemorySegment seg, long index) {
        return (double)constants$195.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static double t_p_eval_ms$get(MemorySegment seg) {
        return (double)constants$195.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static double t_p_eval_ms$get(MemorySegment seg, long index) {
        return (double)constants$195.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static double t_eval_ms$get(MemorySegment seg) {
        return (double)constants$196.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static double t_eval_ms$get(MemorySegment seg, long index) {
        return (double)constants$196.const$0.get(seg.asSlice(index*sizeof()));
    }
