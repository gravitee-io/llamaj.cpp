...
final class constants$144 {
    ...
    static final VarHandle const$1 = constants$144.const$0.varHandle(PathElement.groupElement("n_ctx"));
    static final VarHandle const$2 = constants$144.const$0.varHandle(PathElement.groupElement("n_batch"));
    static final VarHandle const$3 = constants$144.const$0.varHandle(PathElement.groupElement("n_ubatch"));
    static final VarHandle const$4 = constants$144.const$0.varHandle(PathElement.groupElement("n_seq_max"));
    static final VarHandle const$5 = constants$144.const$0.varHandle(PathElement.groupElement("n_threads"));
}
