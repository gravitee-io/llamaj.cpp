...
final class constants$2 {
    ...
    private constants$2() {}
    static final VarHandle const$0 = constants$1.const$5.varHandle(PathElement.groupElement("__sig"));
    ...
    static final VarHandle const$2 = constants$2.const$1.varHandle(PathElement.groupElement("__sig"));
    static final StructLayout const$3 = MemoryLayout.structLayout(
        JAVA_LONG.withName("__sig"),
        MemoryLayout.sequenceLayout(56, JAVA_BYTE).withName("__opaque")
    ).withName("_opaque_pthread_mutex_t");
    static final VarHandle const$4 = constants$2.const$3.varHandle(PathElement.groupElement("__sig"));
