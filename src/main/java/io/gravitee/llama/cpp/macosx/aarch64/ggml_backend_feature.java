...
public class ggml_backend_feature {
    ...
    public static MemorySegment name$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$121.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet lang=c :
    ...
    public static MemorySegment name$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$121.const$3.get(seg.asSlice(index*sizeof()));
    }
