...
final class constants$152 {
    ...
    static final VarHandle const$0 = constants$150.const$0.varHandle(MemoryLayout.PathElement.groupElement("use_mmap"));
    static final VarHandle const$1 = constants$150.const$0.varHandle(MemoryLayout.PathElement.groupElement("use_mlock"));
    static final VarHandle const$2 = constants$150.const$0.varHandle(MemoryLayout.PathElement.groupElement("check_tensors"));
    ...
    static final VarHandle const$4 = constants$152.const$3.varHandle(MemoryLayout.PathElement.groupElement("n_ctx"));
    static final VarHandle const$5 = constants$152.const$3.varHandle(MemoryLayout.PathElement.groupElement("n_batch"));
}
