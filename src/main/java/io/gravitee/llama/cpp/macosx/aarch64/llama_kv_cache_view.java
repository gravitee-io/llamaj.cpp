...
public class llama_kv_cache_view {
    ...
    public static int token_count$get(MemorySegment seg) {
        return (int)constants$171.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet lang=c :
    ...
    public static int token_count$get(MemorySegment seg, long index) {
        return (int)constants$171.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int used_cells$get(MemorySegment seg) {
        return (int)constants$171.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet lang=c :
    ...
    public static int used_cells$get(MemorySegment seg, long index) {
        return (int)constants$171.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int max_contiguous_idx$get(MemorySegment seg) {
        return (int)constants$172.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet lang=c :
    ...
    public static int max_contiguous_idx$get(MemorySegment seg, long index) {
        return (int)constants$172.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment cells$get(MemorySegment seg) {
        return (MemorySegment)constants$172.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet lang=c :
    ...
    public static MemorySegment cells$get(MemorySegment seg, long index) {
        return (MemorySegment)constants$172.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment cells_sequences$get(MemorySegment seg) {
        return (MemorySegment)constants$172.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet lang=c :
    ...
    public static MemorySegment cells_sequences$get(MemorySegment seg, long index) {
        return (MemorySegment)constants$172.const$2.get(seg.asSlice(index*sizeof()));
    }
