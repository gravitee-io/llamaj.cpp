...
public class llama_kv_cache_view {
    ...
    public static int n_cells$get(MemorySegment seg) {
        return (int)constants$174.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet lang=c :
    ...
    public static int n_cells$get(MemorySegment seg, long index) {
        return (int)constants$174.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int n_seq_max$get(MemorySegment seg) {
        return (int)constants$174.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet lang=c :
    ...
    public static int n_seq_max$get(MemorySegment seg, long index) {
        return (int)constants$174.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int token_count$get(MemorySegment seg) {
        return (int)constants$174.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet lang=c :
    ...
    public static int token_count$get(MemorySegment seg, long index) {
        return (int)constants$174.const$3.get(seg.asSlice(index*sizeof()));
    }
